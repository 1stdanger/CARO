                        ...
                        for (i = 0; i < 5; i++)
                            if (b.cells[rw, cl + i] == ' ')
                            {
                                if (cComputer == 0)
                                {
                                    ...
                                    if (zingLaw && b.CheckPosition(rw, cl - 1) && b.CheckPosition(rw, cl + 5) && 
                                            b.cells[rw, cl - 1] == _computer && b.cells[rw, cl + 5] == _computer)
                                        Val[rw, cl + i] = 0;
                                }
                                if (cPlayer == 0)
                                {
                                    ...
                                    if (zingLaw && b.CheckPosition(rw, cl - 1) && b.CheckPosition(rw, cl + 5) && 
                                            b.cells[rw, cl - 1] == _player && b.cells[rw, cl + 5] == _player)
                                        Val[rw, cl + i] = 0;
                                }
                                if (zingLaw && (cComputer == 4 || cPlayer == 4) && ((b.CheckPosition(rw, cl + i - 1) && b.cells[rw, cl + i - 1] == ' ') 
                                                               || (b.CheckPosition(rw, cl + i + 1) && b.cells[rw, cl + i + 1] == ' ')))
                                    Val[rw, cl + i] *= 2;
                        ...
                        for (i = 0; i < 5; i++)
                            if (b.cells[rw + i, cl] == ' ')
                            {
                                if (cComputer == 0)
                                {
                                    ...
                                    if (zingLaw && b.CheckPosition(rw - 1, cl) && b.CheckPosition(rw + 5, cl) && 
                                            b.cells[rw - 1, cl] == _computer && b.cells[rw + 5, cl] == _computer)
                                        Val[rw + i, cl] = 0;
                                }
                                if (cPlayer == 0)
                                {
                                    ...
                                    if (zingLaw && b.CheckPosition(rw - 1, cl) && b.CheckPosition(rw + 5, cl) && 
                                            b.cells[rw - 1, cl] == _player && b.cells[rw + 5, cl] == _player)
                                        Val[rw + i, cl] = 0;
                                }
                                if (zingLaw && (cComputer == 4 || cPlayer == 4) && ((b.CheckPosition(rw + i - 1, cl) && b.cells[rw + i - 1, cl] == ' ') 
                                                               || (b.CheckPosition(rw + i + 1, cl) && b.cells[rw + i + 1, cl] == ' ')))
                                    Val[rw + i, cl] *= 2;
                                else if (cComputer == 4 || cPlayer == 4)
                                    Val[rw + i, cl] *= 2;
                            }
                        ...
                        for (i = 0; i < 5; i++)
                            if (b.cells[rw + i, cl + i] == ' ')
                            {
                                if (cComputer == 0)
                                {
                                    ...
                                    if (zingLaw && b.CheckPosition(rw - 1, cl - 1) && b.CheckPosition(rw + 5, cl + 5) && 
                                            b.cells[rw - 1, cl - 1] == _computer && b.cells[rw + 5, cl + 5] == _computer)
                                        Val[rw + i, cl + i] = 0;
                                }
                                if (cPlayer == 0)
                                {
                                    ...
                                    if (zingLaw && b.CheckPosition(rw - 1, cl - 1) && b.CheckPosition(rw + 5, cl + 5) && 
                                            b.cells[rw - 1, cl - 1] == _player && b.cells[rw + 5, cl + 5] == _player)
                                        Val[rw + i, cl + i] = 0;
                                }
                                if (zingLaw && (cComputer == 4 || cPlayer == 4) && ((b.CheckPosition(rw + i - 1, cl + i - 1) && b.cells[rw + i - 1, cl + i - 1] == ' ') 
                                                               || (b.CheckPosition(rw + i + 1, cl + i + 1) && b.cells[rw + i + 1, cl + i + 1] == ' ')))
                                    Val[rw + i, cl + i] *= 2;
                                else if (cComputer == 4 || cPlayer == 4)
                                    Val[rw + i, cl + i] *= 2;
                            }
